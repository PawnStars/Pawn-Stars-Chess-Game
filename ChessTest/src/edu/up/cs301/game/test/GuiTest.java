...
/**
 * Tests the GUI to make sure the buttons appear for any screen size and they
 * carry out their purpose on the GUI
 * 
...
public class GuiTest extends
		ActivityInstrumentationTestCase2<ChessMainActivity> {
	...
	/**
	 * Tests that the quit button is visible on the screen for any given screen
	 * size
	 */
	...
	/**
	 * Tests that the flip board button is on the screen and flips the board
	 * when pressed
	 */
	public void testFlipButton() {
		...
		//.clickView(this, flipButton);
		boolean isFlipped = board.isFlipped();

		assertTrue("The board was flipped", true);
	}
