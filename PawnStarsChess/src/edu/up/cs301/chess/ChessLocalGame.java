...
public class ChessLocalGame extends LocalGame implements ChessGame {
	 ...
	 * 
	 * @return true, if it is this player's turn and false if not
	 */
	@Override
	...
	/**
	 * The actions that should be sent are ChessMoveAction, SelectPieceAction,
	 * SelectUpgradeAction, ResignAction, and DrawActions. It returns true if it
	 * can handle the action and false if it cannot.
	 */
	@Override
	public boolean makeMove(GameAction action) {
		...
		if (action instanceof ChessMoveAction) {
			...
			/*
			 * Ask the other player if the draw was not confirmed by both
			 * players
			 */
	 ...
	 * winner, if any, is. If the game is not over, return null.
	 * 
